...
const scheduleNotifyService = {
    ...
    createNotifyToLessor: async () => {
        ...
        console.log("🚀 ~ file: schedule-notify.service.js:13 ~ createNotifyToLessor: ~ lessorIds:", lessorIds)
        ...
        for (let i = 0; i < lessorIds.length; i++) {
            ...
            await sendNotify({ to: user.email, inMonth: today.getMonth() + 1, inYear: today.getFullYear(), name: user.name });
        }
